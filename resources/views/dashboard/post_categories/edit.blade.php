            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Edit Post Category<small></small></h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <div class="card-body">
                        ...
                        @endif
                        <form role="form" action="{{route('postcategories.update', $category->id)}}" method="post" enctype="multipart/form-data" id="form-notif">
                            @csrf
                            @method('PUT')
                            <div class="row">
