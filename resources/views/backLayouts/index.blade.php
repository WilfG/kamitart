...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="artfric/public/plugins/fontawesome-free/css/all.min.css">
    <!-- Ionicons -->
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="artfric/public/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023 <a href="kamitart.com">KamitArt</a>.</strong>
            All rights reserved.
